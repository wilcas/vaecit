...
mmd_cit_train2_df <- read.csv("../data/mmd_vae_new_train/perm_test_mmdvae_1_latent_depth_10_cit.csv") %>%
  rename(mmd_train_p1 = p1,mmd_train_p2 = p2, mmd_train_p3 = p3,mmd_train_p4 = p4,mmd_train_omni_p = omni_p)
mmd_cit_rev_train2_df <- read.csv("../data/mmd_vae_new_train/perm_test_rev_mmdvae_1_latent_depth_10_cit.csv") %>%
...
summary_1 %>% ggplot(aes(x=corr)) + geom_histogram()
...
summary_2 %>% ggplot(aes(x=corr)) + geom_histogram()
# library(Matrix)
# library(CCA)
